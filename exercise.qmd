...
Almost same as before, but now we have varying slopes as well as intercepts.
...
```{r vslope-brm-curves, fig.height=5.5, message=FALSE, eval=TRUE}
...
**Not convergent!**
It's hard to fit this kind of complex multilevel model with MLE framework like `lme4`.
