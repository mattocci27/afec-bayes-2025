...
We can also speficy priors for the parameters.
...
where $\boldsymbol{\beta}$ is a 1 $\times$ 3 coefficent matrix and $\boldsymbol{x_i}$ is a 3 $\times$ 1 predictor matrix (including intercept).
